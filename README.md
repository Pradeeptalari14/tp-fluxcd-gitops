# 🔄 FluxCD GitOps Studio
> Configure source controllers and GitOps reconciliation pipelines. Build Repository sources, Kustomizations, and simulate automated cluster sync loops.

[![Studio](https://img.shields.io/badge/Developer_Studio-Live-brightgreen)](https://pradeeptalari14.github.io/portfolio/tools/fluxcd-gitops/)
...
```
1. Open Studio → https://pradeeptalari14.github.io/portfolio/tools/fluxcd-gitops/
...
```bash
git clone https://github.com/Pradeeptalari14/tp-fluxcd-gitops.git
cd tp-fluxcd-gitops
...
| Resource | Link |
|----------|------|
| Interactive Studio | [Open →](https://pradeeptalari14.github.io/portfolio/tools/fluxcd-gitops/) |
